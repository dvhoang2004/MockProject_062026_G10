import "./IncidentDetailUnlocked.css";
    ...
    <div className="incident-page">
      ...
      <div className="incident-content">
        ...
        <div className="incident-right">
          ...
          <div className="incident-card checklist-card">
            <h3>Resolution Checklist</h3>
            <span className="checklist-sub">Auto-derived — not DON-tickable (UC-M7-10)</span>
            
            <div className="checklist-item">
              <span>Progress Notes logged</span>
              <span className="check-badge green-light">2</span>
            </div>
            ...
            <div className="checklist-item">
              ...
              <span className="check-badge gray-light">Not Submitted</span>
            </div>

            <div className="checklist-footer">
              <p>1 Documentation marked complete</p>
              <small>— Anna Lee, RN - 10:05</small>
            </div>
          </div>
          ...
          <div className="incident-card">
            ...
            <button className="incident-action-btn disabled" disabled>
              Chart Already Unlocked
            </button>
